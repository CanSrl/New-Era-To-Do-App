...
English docs for buyers of this starter kit (and for this repo as a freemium product).
...
| [billing.md](./billing.md) | LemonSqueezy, Pro gate, secrets that must never be `VITE_` |
| [teams.md](./teams.md) | `workspace_id` migration path — not built in v1 |

Internal design history lives under `docs/superpowers/` (plans and specs). It is not the buyer-facing set.
